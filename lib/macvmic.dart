...
class Macvmic extends StatefulWidget {
  const Macvmic({Key? key}) : super(key: key);
  static const routename = "macvmicroute";

  @override
  MacvmicState createState() => MacvmicState();
}

class MacvmicState extends State<Macvmic> {
  int currentIndex = 0;
  late File _image;
  late List _results;
  ...
  Future loadModel() async {
    ...
    res = (await Tflite.loadModel(
        model: "assets/macmicpretest_model_unquant.tflite",
        labels: "assets/macmicpretestlabels.txt"))!;
